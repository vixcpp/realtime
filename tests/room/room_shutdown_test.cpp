/**
 *
 * @file room_shutdown_test.cpp
 * @author Gaspard Kirira
 * @brief Tests for clean shutdown of Vix Realtime rooms.
 *
...
namespace vix::realtime
{
  namespace
  {
    ...
    TEST(RoomShutdownTest, ShutsDownOpenRoom)
    {
      RoomFixture fixture =
          make_fixture();
    ...
    TEST(RoomShutdownTest, ShutdownIsIdempotent)
    {
      RoomFixture fixture =
          make_fixture();
    ...
    TEST(RoomShutdownTest, PreservesFinalState)
    {
      RoomFixture fixture =
          make_fixture(
              Config{},
    ...
    TEST(RoomShutdownTest, PreservesFinalStreamPosition)
    {
      RoomFixture fixture =
          make_fixture();
    ...
    TEST(RoomShutdownTest, RemovesEveryRoomMember)
    {
      RoomFixture fixture =
          make_fixture();
    ...
    TEST(RoomShutdownTest, RejectsCommandsAfterShutdown)
    {
      RoomFixture fixture =
          make_fixture(
              Config{},
    ...
    TEST(RoomShutdownTest, CreatesFinalSnapshotWhenEnabled)
    {
      Config config;
    ...
    TEST(RoomShutdownTest, DoesNotCreateFinalSnapshotWhenDisabled)
    {
      Config config;
    ...
    TEST(RoomShutdownTest, DoesNotDuplicateSnapshotAtSamePosition)
    {
      Config config;
    ...
    TEST(RoomShutdownTest, FinalSnapshotCanRestoreAnotherRoomInstance)
    {
      Config config;
